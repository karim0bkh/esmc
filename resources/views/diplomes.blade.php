        ...
        if($rowCount % $numOfCols == 0) { ?> <div class="row"> <?php }
            ...
            <div class=" col-md-<?php echo $bootstrapColWidth; ?>">
                ...
                <div  class="card m-3" style="width: 18rem;">
                    <img class="card-img-top" src="imgs/{{$diplomes->img_name}}" alt="image diplomes" height="250">
                    <div class="card-body">
                        <h5 class="card-title">{{$diplomes->name}}</h5>
                        <p class="card-text">{{$diplomes->desc}}</p>
                    </div>
                    <ul class="list-group list-group-flush">
                        <li class="list-group-item">Prof : {{$diplomes->prof}}</li>
                        <li class="list-group-item">Date : {{$diplomes->datee}}</li>
                        <li class="list-group-item">Prix : {{$diplomes->price}}</li>
                    </ul>
                    <div class="card-body">
                        <a href="{{ route('diplomes_show2', encrypt($diplomes->id)) }}" class="btn btn-dark">Voir diplomes</a>
                    </div>
                </div>
            </div>
